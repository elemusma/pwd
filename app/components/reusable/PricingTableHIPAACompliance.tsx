...
const PricingTableHIPAACompliance = () => {
  const plans = [
    {
      title: "Starter",
      price: "$4,000.00",
      ...
      features: [
        "4 weeks timeline",
        "SSL Certificate",
        "HIPAA-Compliant Hosting Guidance",
        "Privacy Policy (HIPAA-Ready)",
        "Secure, Consent-Based Contact Form",
        "Attorney-Focused Copywriting",
        "On-Page SEO Optimization",
        "Mobile Optimization",
        "Google Analytics Setup (HIPAA-Safe)",
        "ADA Compliance Setup",
        "Schema Markup",
        "3 Pages Including Homepage",
      ],
      color: "text-[#b5539f]",
...
export default PricingTableHIPAACompliance;
