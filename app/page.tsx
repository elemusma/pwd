            ...
            <div className="flex flex-wrap md:flex-row-reverse justify-center mx-4">
              <div className="lg:w-1/2 w-full md:px-4">
                <div className="relative w-full pb-[56.25%] h-0">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/u26obDlFMD4?list=PL8V1pLWolwwUEMH7MC0_cMQhmqiTGv6Md&rel=0&modestbranding=1"
              ...
              <div className="lg:w-1/2 w-full pb-4">
                ...
                <p className="text-md mt-4 mb-4">
                  A good-looking site that nobody finds or trusts isn&apos;t doing its job. I fix both problems and create content that makes your clients find you when they&apos;re actively searching for an expert like you. 
                </p>
                {/* <Login /> */}
                {/* </div> */}
                <CTAButtons />
            ...
            <div className="flex flex-wrap justify-center items-center">
              ...
              <div className="lg:w-5/12 w-full px-4 pb-4">
                <div className="relative w-full pb-[56.25%] h-0">
                  ...
                  <iframe
                    className="absolute top-0 left-0 w-full h-full"
                    src="https://www.youtube.com/embed/32x4qh6aaq4?list=PL8V1pLWolwwUEMH7MC0_cMQhmqiTGv6Md&rel=0&modestbranding=1"
                    title="YouTube video player"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerPolicy="strict-origin-when-cross-origin"
              ...
              <div className="lg:w-5/12 w-full px-4 pb-4">
                <div className="relative w-full pb-[56.25%] h-0">
                  <iframe
                    className="absolute top-0 left-0 w-full h-full"
                    src="https://www.youtube.com/embed/56RVJqZdkNc?list=PL8V1pLWolwwUEMH7MC0_cMQhmqiTGv6Md&rel=0&modestbranding=1"
                    title="YouTube video player"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerPolicy="strict-origin-when-cross-origin"
